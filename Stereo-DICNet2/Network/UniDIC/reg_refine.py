...
class BasicMotionEncoder_flow(nn.Module):
    def __init__(self, corr_channels=324,
                 flow_channels=2,
                 ):
        super(BasicMotionEncoder_flow, self).__init__()
...
class BasicMotionEncoder_disp(nn.Module):
    def __init__(self, corr_channels=324,
                 flow_channels=1,
                 ):
        super(BasicMotionEncoder_disp, self).__init__()
...
class BasicUpdateBlock_flow(nn.Module):
    def __init__(self, corr_channels=324,
                 hidden_dim=128,
                 context_dim=128,
                 downsample_factor=8,
        ...
        super(BasicUpdateBlock_flow, self).__init__()

        self.encoder = BasicMotionEncoder_flow(corr_channels=corr_channels,
                                          flow_channels=flow_dim,
                                          )
...
class BasicUpdateBlock_disp(nn.Module):
    def __init__(self, corr_channels=324,
                 hidden_dim=128,
                 context_dim=128,
                 downsample_factor=8,
        ...
        super(BasicUpdateBlock_disp, self).__init__()

        self.encoder =  BasicMotionEncoder_disp(corr_channels=corr_channels,
                                          flow_channels=flow_dim,
                                          )
